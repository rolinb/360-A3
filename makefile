...
readTest: $(TESTS)/readFilesTest.o $(FILE)/File.o $(DISK)/disk.o
	gcc -Wall -Werror -o $(TESTS)/readFilesTest $(TESTS)/readFilesTest.o $(FILE)/File.o $(DISK)/disk.o
disk.o: $(DISK)/disk.c
...
readFilesTest.o: $(TESTS)/readFilesTest.c
	gcc -Wall -Werror -c $(TESTS)/readFilesTest.c
